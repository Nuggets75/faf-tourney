...
/**
 * Find a player in a tournament by id.
 * @param {{ players: Array<{id:string}> }} t
 * @param {string} pid
 * @returns {any|null}
 */
...
/**
 * Find a team in a tournament by id.
 * @param {{ teams: Array<{id:string}> }} t
 * @param {string} tid
 * @returns {any|null}
 */
...
/**
 * Find a match in a tournament by id.
 * @param {{ matches: Array<{id:string}> }} t
 * @param {string} mid
 * @returns {any|null}
 */
